    ...
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            items = new List<Item>()
            {
                ...
                new Item {Id = Guid.NewGuid().ToString(), Is_ITPRISLection = true, Text = "Введение в технологии языка сценариев для пользователей без базовых знаний", Description = "Лекция по ИТПРИС", Link = @"https://drive.google.com/file/d/1oJyn2ZAV-otM7f_3xCNv9wsaZCWcV_Vl/view?usp=sharing" },
